...
<div class="span12" >
    ...
    <div class="span5" style="background-color:#f0fff0; border-color:#4b0082">
        <h4> Pronóstico</h4>
        <b>
            En estos momentos el sistema está calculando la fecha  y la hora que no será posible atender más pedidos.</b>
        <br>
        Sr. Administrador 
        La Fecha en la que no se puede atender más pedidos es:
        <br>
            ...
            <form class="form-horizontal" name="filtros" >
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <label>Cliente
                            <input type="text" name="_idCliente" >
                        </label>
   ...
   <div class="span5" style="background-color:#f0fff0;" >
...
<script type="text/JavaScript">
    ...
    var ruta="actualizaPosRutaPronostico.html";
    var urlInicial="getInicialesPronostico.html";
</script>
