...
<div class="page-header">
    <h3>Búsqueda de Datos Finales Pronóstico </h3>
    <b> 1.</b> Escoja la fecha de Pronóstico<br>
    <b> 2.</b> Le mostrará los números de paquetes atendidos hasta la fecha.
</div>
...
<li class="span7">
    <form  action="pedido.html" method="post" id="form1" name="form1">
        ...
        <div class="well">
            ...
            <label class="control-label" style="margin-right: 10px"> Fecha Pronóstico   : </label>
        ...
        <li class="span4">
            <div class="thumbnail">
                ...
                <div class="caption">
                    <h5>Buscar Datos Finales Pronóstico</h5>
                    <p>Busque los datos del pronóstico realizado</p>
            ...
            function llenarHistory() {
                ...
                xmlhttp.onreadystatechange = function() {
                    if (xmlhttp.readyState === 4 && xmlhttp.status === 200) {
                        ...
                        tabla.innerHTML = "<tr><th>Código de Pronóstico</th>" +
                                "<th>Fecha de Pronóstico</th>" +
                                "<th>numPaquetes</th>" +
                        "</tr>";
